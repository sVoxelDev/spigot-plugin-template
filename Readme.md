[![Build Status](https://github.com/Silthus/spigot-plugin-template/workflows/Build/badge.svg)](https://github.com/Silthus/spigot-plugin-template/actions?query=workflow%3ABuild)
